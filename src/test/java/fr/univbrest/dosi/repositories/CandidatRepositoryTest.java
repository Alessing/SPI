...
public class CandidatRepositoryTest {
    ...
    public void doitRécupérerUnCandidatParNom() {
        List<Candidat> resultat = Lists.newArrayList(candidatRepo.findByNom("LF"));
    ...
    public void doitRécupérerUnCandidatParUniversiteOrigine() {
        List<Candidat> resultat = Lists.newArrayList(candidatRepo.findByUniversiteOrigine("Univ 1"));
